  ...
  return (
    <div className="flex items-center justify-center gap-3 p-4 bg-gray-900">
      ...
      <button
        onClick={toggleCam}
        className={`p-3 ${
          isCamOn ? "bg-red-600 hover:bg-red-500" : "bg-gray-700 hover:bg-gray-600"
        } text-white`}
        title={isCamOn ? "Turn on camera" : "Turn off camera"}
      >
        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          {isCamOn ? (
      ...
      <button
        onClick={leaveCall}
        className="p-3 bg-red-600 hover:bg-red-500 text-white"
        title="Leave"
      >
        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
