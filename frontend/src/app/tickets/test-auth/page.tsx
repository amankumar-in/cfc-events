...
export default function TestPesapalAuthPage() {
  ...
  const testAuth = async () => {
    ...
    try {
      const response = await fetch("/api/tickets/pesapal-auth", {
        method: "POST",
        headers: {
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-gray-900">
            Test Pesapal API 3.0 Authentication
          </h1>
          <p className="mt-2 text-gray-600">
            This page tests the authentication with Pesapal API 3.0 using your
